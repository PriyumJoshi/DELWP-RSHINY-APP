...
getExtent = function(coordinates.c) {
  colnames(coordinates.c)[colnames(coordinates.c)=="X"] <- "lon"
  colnames(coordinates.c)[colnames(coordinates.c)=="Y"] <- "lat"
  # print(colnames(coordinates.c))
  ext = raster::extent(
...
plot_ = function(p, a, extent, plotAbs = TRUE) {
  ...
  colnames(p)[colnames(p)=="X"] <- "lon"
  colnames(p)[colnames(p)=="Y"] <- "lat"
  colnames(a)[colnames(a)=="X"] <- "lon"
  colnames(a)[colnames(a)=="Y"] <- "lat"
